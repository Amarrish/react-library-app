...
const Trending = () => {
  ...
  const TrendingBooks = allbooks.filter((book) => book.category === "trending");
  return (
    <>
      <div className='mt-3 w-auto'>
        <h3  className='p-3 bg-primary text-light'>Trendingbooks</h3>
    ...
    <Button  type="submit">Confirm your Payment</Button>
            ...
            <p style={{fontWeight:'900', fontSize:'20px'}}><img src={oopsimg} alt="no img" style={{width:'100px',height:'100px', borderRadius:'50%'}} /> There is no Trending books are availabe now!!!...</p>
          )}
        </div>
      </div>
    </>
