...
const Classicbooks = () => {
  ...
  // Filter books with category "classic"
  const classicBooks = allbooks.filter((book) => book.category === "classic");

  return (
    <>
      <div className='mt-3 '>
        <h3 className='p-3 bg-primary text-light'>Classicbooks</h3>
      ...
      <Button  type="submit">Confirm your Payment</Button>
            ...
            <p style={{fontWeight:'900', fontSize:'20px'}}><img src={oopsimg} alt="no img" style={{width:'100px',height:'100px', borderRadius:'50%'}} /> There is no Classic books are availabe now!!!...</p>
          )}
        </div>
