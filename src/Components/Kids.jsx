...
const Kids = () => {
    ...
    // Filter books with category "kids"
    const kidsBooks = allbooks.filter((book) => book.category === "kids");
  return (
    <>
     <div className='mt-3 '>
        <h3 className='p-3 bg-primary text-light'>kidsbooks</h3>
      ...
      <Button  type="submit">Confirm your Payment</Button>
            ...
            <p style={{fontWeight:'900', fontSize:'20px'}}><img src={oopsimg} alt="no img" style={{width:'100px',height:'100px', borderRadius:'50%'}} /> There is no kids books are availabe now!!!...</p>
          )}
        </div>
